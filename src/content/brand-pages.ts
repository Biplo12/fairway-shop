...
export const brandPages: Record<string, BrandPage> = {
  titleist: {
    ...
    since: "1987",
    image: "/images/brands/titleist.jpg",
    alt: "A golf ball sitting on a tee against a black studio background",
    body: [
  ...
  ping: {
    ...
    since: "1987",
    image: "/images/brands/ping.jpg",
    alt: "A golfer walking a wide fairway with a bag standing behind them",
    body: [
  ...
  mizuno: {
    ...
    home: "Osaka, Japan",
    since: "1990",
    image: "/images/brands/mizuno.jpg",
    alt: "A golfer at the finish of a swing, in black and white",
    body: [
  ...
  vokey: {
    ...
    home: "Fairhaven, Massachusetts",
    since: "1997",
    image: "/images/brands/vokey.jpg",
    alt: "A golfer playing out of a bunker, sand in the air",
    body: [
  ...
  footjoy: {
    ...
    home: "Fairhaven, Massachusetts",
    since: "1987",
    image: "/images/brands/footjoy.jpg",
    alt: "Gloved hands closed around the grip of a club",
    body: [
  ...
  cleveland: {
    ...
    since: "1996",
    image: "/images/brands/cleveland.jpg",
    alt: "A golfer hitting out of a sandy lie, dust in the air",
    body: [
