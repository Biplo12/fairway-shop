...
/**
 * A plain form and a grid. The catalogue is a typed module, so the search runs
 * on the server against the same list the shelves read: no index, no guessing
 * at what somebody meant, and one address per query like every other view.
 */
