...
const subjects = [
  "An order",
  "A club, before I buy it",
  "A repair or a regrip",
  "Something else",
];

/**
 * The counter, in a field. Kept apart from the page so everything around it
 * stays a server component, and kept local on submit because there is no inbox
 * behind this site, the same as the booking form and the letter.
 *
 * Fittings are not booked here. That form asks for a date and a session and
 * lives on the fitting page, so this one points at it rather than duplicating
 * it badly.
 */
