...
/**
 * The sessions, sold the way the rack sells a club: a photograph, a price, and
 * the one question a customer walked in with. The panel lifts over the band
 * above it, so the photograph runs on behind its shoulders, the same join the
 * shop pages use.
 *
 * Each card carries the session slug as an id, so the footer can point at a
 * single session, and the booking link hands that slug to the form through the
 * query rather than through client state.
 */
