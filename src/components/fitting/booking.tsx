import { BookingForm } from "@/components/fitting/booking-form";
import { Media } from "@/components/ui/media";
import { bring, fullBag, hours, sessions } from "@/content/fitting";

/**
 * The counter itself: a photograph, the form, and underneath it the three
 * things somebody asks on the phone, when we are open, what to bring and
 * where the door is.
 *
 * The form is the only client component on the page. Everything around it,
 * including the session it opens on, is decided on the server.
 */
