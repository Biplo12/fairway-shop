...
/**
 * The checkout runs in its own room. No navigation tabs, no floating pill and
 * no footer full of links, because everything on this page is either the order
 * or the way back to the bag.
 *
 * The card language stays, so a customer has not left the shop, only stepped
 * up to the counter.
 */
