...
/**
 * What is being bought, held beside the form so it never scrolls out of sight
 * on a wide screen. Prices move with the delivery choice, because a customer
 * changing their mind about carriage should see the total change as they do
 * it, not on the next step.
 */
