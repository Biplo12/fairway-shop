...
/**
 * Nobody shops for a club. They shop for a wedge, or for the gap between a
 * five iron and a three wood. Two hundred clubs behind one tile is two hundred
 * clubs nobody finds, so the six types get their own row and their own count.
 */
