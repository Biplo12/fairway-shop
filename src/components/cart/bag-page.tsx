...
/**
 * The bag as a page, for the customer who wants the whole order in front of
 * them rather than through a panel. Same store behind it as the drawer, so the
 * two can never disagree.
 *
 * The saved bag is read after the first paint, so until it lands the page
 * holds a quiet line rather than flashing an empty bag at somebody who has ten
 * clubs in it.
 */
