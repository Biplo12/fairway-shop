    ...
    <>
      ...
      <main id="main" className="p-3 md:p-5">
        <div className="overflow-hidden rounded-card bg-white">
          ...
          {/* One container on a phone, where the recessed panel and the two
              cards inside it stacked three rounded boxes deep. They draw
              themselves from md up, where there are two columns to separate. */}
