...
import { categoryName, type Product } from "@/content/products";
      ...
      <main id="main" className="p-3 md:p-5">
        <div className="overflow-hidden rounded-card bg-white">
          ...
          <div className="md:px-5 md:py-5">
            <div className="bg-paper p-0 md:rounded-card md:p-6">
              <div className="grid gap-0 md:gap-4 lg:grid-cols-[0.72fr_1fr] lg:gap-6">
                <ProductGallery
                  images={images}
                  alt={product.alt}
                  model={product.model}
                      ...
                      <dl className="grid gap-x-8 gap-y-3 sm:grid-cols-2">
                        {detail.specs.map((spec, index) => {
                          ...
                          return (
                            <div
                              key={spec.label}
                              className={cn("flex items-baseline justify-between gap-4 border-b border-mist pb-2 last:border-0 last:pb-0", inLastRow ? "sm:border-0 sm:pb-0" : "")}
                            >
