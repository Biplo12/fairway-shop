          ...
          <nav aria-label="Sections" className="grid grid-cols-3">
            {tabs.map((tab, i) => (
              <Link
                ...
                className={cn("flex flex-col gap-4 px-3 pb-3 pt-4 text-[0.75rem] leading-tight md:gap-6 md:px-6 md:text-[0.875rem]", i < tabs.length - 1 ? "border-r border-mist/70" : "", tab.current
